    ...
    return (
        <div className="w-full lgl:w-1/2 flex flex-col gap-10 lgl:gap-20">
            <div className="flex flex-col gap-5">
                ...
                <div className="flex justify-center lgl:justify-start items-center"> {/* Added items-center class */}
                    <button
                        ...
                        onClick={openResume}
                    >
                        <GoLinkExternal className="text-white mr-2" /> {/* Added GoLinkExternal logo */}
                        Resume
                    </button>
                </div>
            </div>
